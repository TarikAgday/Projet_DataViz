...
/**
 * @param {{}} data needed data to draw a scatterplot
 */
...
/**
 * @param {object} g the groupe of axis
 */
...
/**
 * @param {object} xScale the group of xScale
 */
...
/**
 * @param {object} g the group where to draw the labels
 */
...
/**
 * @param {object} yScale the uscale used to draw the yaxis
 */
...
/**
 * @param {object} g the group in which the labels will be drawns
 */
...
/**
 * @param {{}} d the information of the team
...
/**
 * @param {{}} g the group in which the legend will be drawn
 */
...
/**
 * @param {{}} g the group in which the button will be drawn
 */
...
/**
 * @param {object} g the group in which the team will be drawn
 */
function moveTeams(g) {
    ...
    circles.transition()
        .duration(1000)
        .attr('cx', function (d) { return xScale(currentSetting === 'general' ? d.pos : d.playoffPos) })
}
